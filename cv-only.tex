...
%         DOTE & PI & \$75,996 & Human Aware AI for Space EW M\&S & 1 & 9/23-12/25 \\
...
%         AFRL/BBN & PI & \$300,000.00 & LWAP-BART & 3 & 7/20-7/22 \\ 
%         AFRL/BBN & PI & \$150,000.00 & WAND  & 2 &  5/19-5/20 \\ 
%         DHS    & TL     & \$1,618,212.00 & FDCE   & 3  & 9/18 - 9/21 \\ 
%         AFRL/BBN & C     & \$212,500.00 & DICE & 1 &8/17-7/19 \\ 
%         DoD    & TL     & \$485,841.00 & MTO & 2 & 11/17-11/18 \\ 
%         DHS    & TL     & \$1,285,246.00 & FC2  & 4 &  7/14-12/18 \\ 
...
%         AFRL   & TL     & \$1,933,000.00 & SBC2  & 3 & 2/13-11/16 \\ 
%         Rockwell Collins & KP  &\$100,000.00& APM & 1 & 3/14-9/15\\ \hline
% As PI & & 		\$826,614.00 & \\
% %As PI/TL last 3 years & & 2,444,826.00		\$2,368,830.00 & \\
% As PI/TL & & \$6,412,667.00 & \\
% Total involvement  &&		\$10,864,294.00 & \\ \hline
%     \end{tabular}
% \end{table}
...
%\newpage
    ...
    \begin{tablist}
        \item[2025] \tab{}$9^{th}$ International Conference on Computer-Human Interaction Research and Applications (CHIRA25)
        ...
        \item[2023-25] \tab{}Senior Committee Florida Conference on Recent Advances in Robotics (FCRAR)
    ...
    \begin{itemize}
        \item \textit{Journal of Theoretical and Experimental Artificial Intelligence}  2016--2019
    \end{itemize}
    ...
    \begin{itemize}
        \item COES Faculty Senator 2024 - current
    ...
    \begin{itemize}
        \item \textbf{2024 Kazuhiko Momose, Compositional Human-Agent Teams, HCD PhD, Houston, TX}
        ...
        \item \textit{expected 2026} Waseem Samkari, CS PhD, Ph.D. Candidate
        \item \textit{expected 2026} Alita Regi, HCD PhD, Ph.D. Candidate
    ...
    \begin{itemize}
        \item \textbf{2025 Anjali Majan, Designing a User-Centered Bias System to Enhance Media Literacy and Factual Accuracy, HCD MS}
        \item \textbf{2025 Lalith Nadipalli, Improving Home Security Through User Centered Device Positioning, HCD MS}
        \item \textbf{2025 Uditkumar Ajitkumar Nair, The Impact of System Transparency on Perceived System Reliability, Perceived System Usability, and Information Clarity in Self-Driving Car Systems, HCD MS}
        \item \textbf{2025 Mahita Uppuluri, Effects of Reflective Journaling and Nudges on Academic Motivation and Engagement, HCD MS}
        \item \textbf{2024 Andrew Biron, TAC-IT: An Affective Computing User Interface Design, HCD MS}
        \item \textbf{2024 Bianca Ebanks, Breaking The Procrastination Barrier: Exploring the Efficacy of an Online Hybrid Intervention, HCD MS}
        \item \textbf{2024 Rahul Mehta, Intent Visualization in Human-Agent Teams, CS MS}
...
Enhancing Efficiency and User Experience, HCD MS, UX Researcher and UI Designer at Macmillan Learning}        
        ...
        \item current Justin Barnwell, HCD MS
        \item current Likhitha Kammara, HCD MS
        \item current Shane Rosenberg, HCD MS
          
    \end{itemize}

    \subsection*{External Committee Member}
    \begin{itemize}
    \item current Clint Jacobs, Modeling the architecture and security of a System of Systems, Computer Science, PhD
    \item current Akram Alghanmi, Toward Robust Perception Models in Robotics, Computer Science, PhD
    ...
    \begin{tablist}
        ...
        \item[2024-- ] \tab{}Sentry View Systems, Melbourne, FL
